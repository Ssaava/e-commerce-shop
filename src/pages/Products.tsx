...
import {popularTags} from "@/assets/data/data.tsx";
            ...
            <section className={"section py-8"}>
                <div className={"grid grid-cols-12 gap-6"}>
                    <div className={"col-span-3"}>
                        ...
                        {/**/}
                        <div className={"p-6 border-4 border-primary-100 text-center flex flex-col gap-2"}>
                    ...
                    <div className={"col-span-9"}>
                        ...
                        <div className={"my-8"}>
                            <div className={"grid grid-cols-4 grid-rows-2 gap-4 flex-grow"}>
                                {/*    Products Card*/}
                                {
                                    products.map(({image, name, price, deals, discount}) => (
