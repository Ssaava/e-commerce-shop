            ...
            <section className={"section py-8"}>
                ...
                <div className={"my-8"}>
                    <Tabs defaultValue="description" className="w-full border-[1px] rounded-md border-gray-200">
                        <TabsList className={"px-6 flex justify-center gap-6 border-b-[1px] border-gray-200"}>
                            <TabsTrigger onClick={()=>handleSetTab("description")} value="description" className={`${tab === "description"? "border-b-4 border-primary-500":""} duration-300 px-6 py-[.8rem]`}>DESCRIPTION</TabsTrigger>
                            <TabsTrigger onClick={()=>handleSetTab("additional-information")} value="additional-information" className={`${tab === "additional-information"? "border-b-4 border-primary-500":""} duration-300 px-6 py-[.8rem]`}>ADDITIONAL INFORMATION</TabsTrigger>
                            <TabsTrigger onClick={()=>handleSetTab("specification")} value="specification" className={`${tab === "specification" ? "border-b-4 border-primary-500":""} duration-300 px-6 py-[.8rem]`}>SPECIFICATION</TabsTrigger>
                            <TabsTrigger onClick={()=>handleSetTab("review")} value="review" className={`${tab === "review"? "border-b-4 border-primary-500":""} px-6 duration-300 py-[.8rem]`}>REVIEW</TabsTrigger>
                        </TabsList>
                        <TabsContent value="description" className={"py-8 px-6 text-sm"}>
                            <div className={"grid grid-cols-4 gap-14"}>
                                ...
                                <div className={"border-l-[1px] border-l-gray-100 pl-6 vertical-spacing"}>
                                    ...
                                    <div className={"flex flex-col gap-2"}>
                                        <p>Courier: <span className={"text-gray-600"}>2-4 days, free shipping</span></p>
                                        <p>Local Shipping: <span className={"text-gray-600"}>up to one week, $19.00</span></p>
                                        <p>UPS Ground Shipping: <span className={"text-gray-600"}>4-6 days, $29.00</span></p>
                                        <p>Uni shop Global Export: <span className={"text-gray-600"}>3-4 days, $39.00</span></p>
                                    </div>
                                </div>
                            </div>
                        </TabsContent>
                        <TabsContent value="additional-information" className={"py-8 px-6"}>Any Additional Information about the product</TabsContent>
                        <TabsContent value="specification" className={"py-8 px-6"}>Add your Product Specification here.</TabsContent>
